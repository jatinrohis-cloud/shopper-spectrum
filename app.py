...
if not MODELS_DIR.exists() or not (MODELS_DIR / "scaler.pkl").exists():
    MODELS_DIR = BASE_DIR

FIGURES_DIR = BASE_DIR / "outputs" / "figures"
if not FIGURES_DIR.exists() or not (FIGURES_DIR / "elbow_plot.png").exists():
...
def load_cleaned_data():
    df = pd.read_csv(DATA_DIR / "cleaned_data.csv.gz")
